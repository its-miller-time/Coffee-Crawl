...
// const URL = "https://api.foursquare.com/v2/venues/search?client_id=ZTBN04P0C1HZICYQWPO4OO1ZXYB2PHMALYZPLKTIOHT34VUL&client_secret=CGG1LF2IHSYQFVBMM4QXT4JREE51LXXVTXX4POHV2WLCQLOD&v=20180323&limit=50&ll=33.848700,-84.373300&query=coffee";

// async function fetchMyData() {
//     const fetchedData = await fetch(URL);
//     const jsonifiedFetchedData = await fetchedData.json();
//     const bacon = makeBreakfast(jsonifiedFetchedData);
//     return bacon;
// }
// fetchMyData();
